...
urlpatterns = [
    ...
    path('modules/<int:module_id>/exercises/', views.ExerciseListView.as_view(), name='exercises'),
    path('modules/<int:module_id>/exercises/<int:pk>', views.ExerciseDetailView.as_view(), name='exercise')
]
